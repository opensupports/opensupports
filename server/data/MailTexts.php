    ...
    return [
        ...
        'ar' => [
          ...
          'USER_SYSTEM_ENABLED' => [
              ...
              'يمكنك الوصول إلى حسابك باستخدام هذا البريد الإلكتروني <i> ({{to}}) </i> وكلمة المرور أدناه. يُرجى تغيير كلمة المرور بمجرد تسجيل الدخول.',
          ],
          'TICKET_CREATED' => [
              '#{{ticketNumber}}  تم إنشاء التذكرة - OpenSupports',
              ' تم إنشاء التذكرة',
              'مرحبًا {{name}}. لقد أرسلت تذكرة جديدة بعنوان <i> {{title}} </i> إلى مركز الدعم الخاص بنا.',
              'يمكنك الوصول إلى التذكرة من خلال رقم التذكرة أو يمكنك النقر على الزر أدناه.',
          ],
          'TICKET_RESPONDED' => [
              '#{{ticketNumber}} رد جديد - OpenSupports',
              'رد جديد',
              'مرحبًا {{name}}. لقد تلقيت ردًا في التذكرة بعنوان <i> {{title}} </i>.',
              'يمكنك النقر على الزر أدناه لرؤية الرد.'
          ],
          'TICKET_CLOSED' => [
             '#{{ticketNumber}} تم إغلاق التذكرة - OpenSupports',
              'تم إغلاق التذكرة',
              'مرحبًا {{name}}. تم إغلاق التذكرة التي أرسلتها بعنوان <i> {{title}} </i>.',
              'يمكنك الوصول إلى التذكرة من خلال رقم التذكرة. أو يمكنك النقر على الزر أدناه.'
          ],
          'TICKET_CREATED_STAFF' => [
              '#{{ticketNumber}} تم إنشاء التذكرة - OpenSupports',
              'تم إنشاء التذكرة',
              'أنشأ المستخدم {{name}} تذكرة جديدة بعنوان <i> {{title}} </i>.',
