...
class MailTexts {
  public static function getTexts() {
    return [
        ...
        'th' => [
          'USER_SIGNUP' => [
            'สมัครสมาชิก {{to}} - OpenSupports',
            'ตรวจสอบบัญชีของคุณ',
            'ยินดีต้อนรับสู่ศูนย์ช่วยเหลือของเรา {{name}}! เราต้องการให้คุณยืนยันอีเมลนี้เพื่อเข้าถึงบัญชีของคุณ ',
            'ใช้รหัสนี้ใน {{url}}/verify-token/{{to}}/{{verificationToken}} หรือคลิกที่ปุ่มด้านล่าง',
          ],
          'USER_PASSWORD' => [
              'แก้ไขรหัสผ่าน - OpenSupports',
              'เปลี่ยนรหัสผ่าน',
              'สวัสดี {{name}} เราต้องการแจ้งให้คุณทราบว่ารหัสผ่านของคุณเปลี่ยนจากแผงลูกค้าของคุณ',
          ],
          'USER_EMAIL' => [
              'แก้ไขอีเมล - OpenSupports',
              'เปลี่ยนอีเมล',
              'สวัสดี {{name}} เราต้องการแจ้งให้คุณทราบว่าอีเมลของคุณเปลี่ยนเป็น {{newemail}} จากแผงลูกค้าของคุณ',
          ],
          'PASSWORD_FORGOT' => [
              'กู้คืนรหัสผ่าน - OpenSupports',
              'กู้คืนรหัสผ่าน',
              'สวัสดี {{name}} คุณขอกู้คืนรหัสผ่าน ',
              'ใช้รหัสนี้ใน {{url}}/recover-password?email={{to}}&token={{token}} หรือคลิกที่ปุ่มด้านล่าง',
          ],
          'USER_INVITE' => [
            'คุณได้รับเชิญ - OpenSupports',
            'คุณได้รับเชิญ',
            'สวัสดี {{name}} คุณได้รับเชิญให้เข้าร่วมศูนย์สนับสนุนของเรา ',
            'ใช้รหัสนี้ใน {{url}}/recover-password?email={{to}}&token={{token}}&invited=true หรือคลิกปุ่มด้านล่างเพื่อตั้งค่ารหัสผ่านของคุณ',
          ],
          'USER_SYSTEM_DISABLED' => [
              'เปลี่ยนการเข้าถึงระบบ - OpenSupports',
              'เปลี่ยนระบบการเข้าถึง',
              'สวัสดี {{name}} ระบบการเข้าถึงตั๋วมีการเปลี่ยนแปลง ',
              'คุณสามารถเข้าถึงและดูตั๋วได้โดยใช้อีเมลและหมายเลขตั๋วคลิกที่ปุ่มด้านล่างเพื่อดูตั๋วของคุณ',
          ],
          'USER_SYSTEM_ENABLED' => [
              'บัญชีที่สร้าง - OpenSupports',
              'สร้างบัญชี',
              'สวัสดี {{name}} เราได้สร้างบัญชีที่คุณสามารถเข้าถึงตั๋วที่คุณส่งให้เรา ',
              'คุณสามารถเข้าถึงบัญชีของคุณโดยใช้อีเมลนี้ <i>({{to}})</i> และรหัสผ่านด้านล่างโปรดเปลี่ยนรหัสผ่านทันทีที่คุณลงชื่อเข้าใช้',
          ],
          'TICKET_CREATED' => [
              '#{{ticketNumber}} สร้างตั๋ว - OpenSupports',
               'สร้างตั๋ว',
               'สวัสดี {{name}} คุณได้ส่งตั๋วใหม่ชื่อ <i>{{title}}</i> ไปยังศูนย์บริการของเรา ',
               'คุณสามารถเข้าถึงตั๋วได้โดยใช้หมายเลขตั๋วหรือคลิกที่ปุ่มด้านล่าง',
          'TICKET_RESPONDED' => [
              '#{{ticketNumber}} การตอบสนองใหม่ - OpenSupports ',
              'ตอบตั๋ว',
              'สวัสดี {{name}} คุณได้รับการตอบกลับในตั๋วที่ชื่อ <i>{{title}}</i> ',
              'โปรดคลิกด้านล่างเพื่อดูคำตอบใหม่',
          ],
          'TICKET_CLOSED' => [
              '#{{ticketNumber}} ปิดตั๋ว - OpenSupports',
              'ปิดตั๋ว',
              'สวัสดี {{name}} ตั๋วที่คุณส่งชื่อ <i>{{title}}</i> ถูกปิดแล้ว ',
              'คุณสามารถเข้าถึงตั๋วได้โดยใช้หมายเลขตั๋ว หรือคุณสามารถคลิกที่ปุ่มด้านล่าง ',
          ],
          'TICKET_CREATED_STAFF' => [
              '#{{ticketNumber}} สร้างตั๋ว - OpenSupports',
              'สร้างตั๋ว',
              'ผู้ใช้ {{name}} ได้สร้างตั๋วใหม่ชื่อ <i>{{title}}</i>',
              'คุณสามารถเข้าถึงตั๋วได้โดยใช้หมายเลขตั๋ว',
          ],
        ],
    ];
  }
