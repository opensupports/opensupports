 ...
 */
/**
 * @apiDefine SUPERVISOR_CAN_NOT_SELECT_HIMSELF
 * @apiError {String} SUPERVISOR_CAN_NOT_SELECT_HIMSELF The supervisor cannot select himself
 */
/**
...
class ERRORS {
    ...
    const SUPERVISOR_CAN_NOT_SELECT_HIMSELF = 'SUPERVISOR_CAN_NOT_SELECT_HIMSELF';
