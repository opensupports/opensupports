  export default {
     ...
     'ALL_NOTIFICATIONS': 'λες οι ειδοποιήσεις',
     ...
     'DATABASE_NAME': 'νομα MySQL βάσης δεδομένων',
     'DATABASE_USER': 'MySQL χρήστης',
     'DATABASE_PASSWORD': 'MySQL κωδικός πρόσβασης',
     'ADMIN_NAME': 'νομα λογαριασμού Διαχειριστή',
     ...
     'ACCOUNT_DESCRIPTION': 'λα τα εισιτήρια σας αποθηκεύονται στο προφίλ του λογαριασμού σας. Παρακολουθήστε όλα τα εισιτήρια που στέλνετε στην ομάδα του προσωπικού μας.',
     ...
     'WILL_DELETE_DEPARTMENT': 'Το τμήμα θα διαγραφεί. λα τα εισιτήρια θα μεταφερθούν στο επιλεγμένο τμήμα.',
