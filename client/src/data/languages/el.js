export default {
    ...
    'EMAIL': 'Email',
    'PASSWORD': 'Κωδικός',
    'REPEAT_PASSWORD': 'Επανάληψη password',
    'LOG_IN': 'Σύνδεση',
    'SIGN_UP': 'Εγγραφή',
    ...
    'CLOSE_SESSION': 'Κλείσιμο session',
    'CREATE_TICKET': 'Δημιουργία Ticket',
    'TICKET_LIST': 'Λίστα Ticket',
    'SUPPORT_CENTER': 'Κέντρο Υποστήριξης',
    'DEPARTMENT': 'Τμήμα',
    'AUTHOR': 'Συγγραφέας',
    'DATE': 'Ημερομηνία',
    'RESPOND': 'Απάντηση',
    'RESPOND_TICKET': 'Απάντηση Ticket',
    ...
    'MY_TICKETS': 'Τα δικά μου Tickets',
    'NEW_TICKETS': 'Καινούργιο Tickets',
    'ALL_TICKETS': 'Όλα τα Tickets',
    ...
    'FILTERS_CUSTOM_FIELDS': 'Φίλτρα και Custom Πεδία',
    ...
    'UN_ASSIGN': 'Unassign',
    'VIEW_TICKET': 'Προβολή Ticket',
    'VIEW_TICKET_DESCRIPTION': 'Ελένξτε το status του ticket σας χρησιμοποιώντας τον αριθμό του ticket και το email σας.',
    'SELECT_CUSTOM_RESPONSE': 'Επιλογή μιας custom απάντησης...',
    'WARNING': 'Προειδοποίηση',
    'INFO': 'Πληροφορία',
    'ALL_DEPARTMENTS': 'Όλα τα τμήματα',
    'EMAIL_BANNED': 'Email banned',
    'UN_BAN': 'Αναίρεση ban',
    'BAN_NEW_EMAIL': 'Ban καινούργιου email',
    'BAN_EMAIL': 'Ban email',
    'EDIT_EMAIL': 'Αλλαγή email',
    'EDIT_PASSWORD': 'Αλλαγή μυστικού κωδικού (password)',
    'CHANGE_EMAIL': 'Αλλαγή email',
    'CHANGE_PASSWORD': 'Αλλαγή μυστικού κωδικού (password)',
    'NAME': 'Όνομα',
    'SIGNUP_DATE': 'Ημερομηνία εγγραφής',
    'SEARCH_USERS': 'Αναζήτηση χρηστών...',
    'SEARCH_EMAIL': 'Αναζήτηση email...',
    ...
    'LAST_EDITED_IN': 'Τελεθταία αλλαγή {date}',
    'EDIT': 'Αλλαγή',
    ...
    //ERRORS
    'EMAIL_OR_PASSWORD': 'Λάθος Email ή password',
    'EMAIL_NOT_EXIST': 'Το Email αυτό δεν είναι μας είναι γνωστό',
    ...
    'PASSWORD_NOT_MATCH': 'Ο κωδικός ασφαλείας σαε (Password) δεν είναι ίδιος',
    ...
    'EMAIL_BANNED_SUCCESSFULLY': 'Το Email έχει γίνει επιτυχώς banned.',
    'WILL_DELETE_STAFF': 'This staff member will be deleted and all its tickets will be unassigned.',
    'WILL_RECOVER_EMAIL_TEMPLATE': 'Αυτό το email template θα ανανηφθεί σε κατάσταση αρχική με την αρχική γλώσσα.',
