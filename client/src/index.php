...
<html class="no-js" lang="">
    <head>
        ...
        <link href="https://stackpath.bootstrapcdn.com/font-awesome/4.8.0/css/font-awesome.min.css" rel="stylesheet" integrity="sha384-wvfXpqpZZVQGK6TAh5PVlGOfQNHSoD2xbE+QkPxCAFlNEevoEH3Sl0sibVcOQVnN" crossorigin="anonymous">
    </head>
    <body>
        <div id="app"></div>
