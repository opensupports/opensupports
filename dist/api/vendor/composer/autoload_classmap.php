...
return array(
    'APIKey' => $baseDir . '/models/APIKey.php',
    'AddAPIKeyController' => $baseDir . '/controllers/system/add-api-key.php',
    'AddArticleController' => $baseDir . '/controllers/article/add.php',
    'AddCustomFieldController' => $baseDir . '/controllers/system/add-custom-field.php',
    'AddCustomResponseController' => $baseDir . '/controllers/ticket/add-custom-response.php',
    'AddDepartmentController' => $baseDir . '/controllers/system/add-department.php',
    'AddTagController' => $baseDir . '/controllers/ticket/add-tag.php',
    'AddTopicController' => $baseDir . '/controllers/article/add-topic.php',
    'Article' => $baseDir . '/models/Article.php',
    'AssignStaffController' => $baseDir . '/controllers/staff/assign-ticket.php',
    'BackupDatabaseController' => $baseDir . '/controllers/system/backup-database.php',
    'Ban' => $baseDir . '/models/Ban.php',
    'BanUserController' => $baseDir . '/controllers/user/ban.php',
    'CSVImportController' => $baseDir . '/controllers/system/csv-import.php',
    'ChangeDepartmentController' => $baseDir . '/controllers/ticket/change-department.php',
    'CheckRequirementsController' => $baseDir . '/controllers/system/check-requirements.php',
    'CheckSessionController' => $baseDir . '/controllers/user/check-session.php',
    'CheckTicketController' => $baseDir . '/controllers/ticket/check.php',
    'CloseController' => $baseDir . '/controllers/ticket/close.php',
    'CommentController' => $baseDir . '/controllers/ticket/comment.php',
    'Composer\\InstalledVersions' => $vendorDir . '/composer/InstalledVersions.php',
    'Controller' => $baseDir . '/libs/Controller.php',
    'ControllerGroup' => $baseDir . '/libs/ControllerGroup.php',
    'CreateController' => $baseDir . '/controllers/ticket/create.php',
    'CreateTagController' => $baseDir . '/controllers/ticket/create-tag.php',
    'CustomResponse' => $baseDir . '/models/CustomResponse.php',
    'CustomValidations\\Captcha' => $baseDir . '/libs/validations/captcha.php',
    'CustomValidations\\Content' => $baseDir . '/libs/validations/content.php',
    'CustomValidations\\DataStoreId' => $baseDir . '/libs/validations/dataStoreId.php',
    'CustomValidations\\StaffEmail' => $baseDir . '/libs/validations/staffEmail.php',
    'CustomValidations\\UserEmail' => $baseDir . '/libs/validations/userEmail.php',
    'CustomValidations\\ValidAuthorsBlackList' => $baseDir . '/libs/validations/validAuthorsBlackList.php',
    'CustomValidations\\ValidAuthorsId' => $baseDir . '/libs/validations/validAuthorsId.php',
    'CustomValidations\\ValidAuthorsList' => $baseDir . '/libs/validations/validAuthorsList.php',
    'CustomValidations\\ValidDateRange' => $baseDir . '/libs/validations/validDateRange.php',
    'CustomValidations\\ValidDepartmentName' => $baseDir . '/libs/validations/validDepartmentName.php',
    'CustomValidations\\ValidDepartmentsId' => $baseDir . '/libs/validations/validDepartmentsId.php',
    'CustomValidations\\ValidLanguage' => $baseDir . '/libs/validations/validLanguage.php',
    'CustomValidations\\ValidOptions' => $baseDir . '/libs/validations/validOptions.php',
    'CustomValidations\\ValidOrderBy' => $baseDir . '/libs/validations/validOrderBy.php',
    'CustomValidations\\ValidOwnersId' => $baseDir . '/libs/validations/validOwnersId.php',
    'CustomValidations\\ValidTagsId' => $baseDir . '/libs/validations/validTagsId.php',
    'CustomValidations\\ValidTicketNumber' => $baseDir . '/libs/validations/validTicketNumber.php',
    'CustomValidations\\ValidUsersId' => $baseDir . '/libs/validations/validUsersId.php',
    'Customfield' => $baseDir . '/models/CustomField.php',
    'Customfieldoption' => $baseDir . '/models/CustomFieldOption.php',
    'Customfieldvalue' => $baseDir . '/models/CustomFieldValue.php',
    'DataStore' => $baseDir . '/models/DataStore.php',
    'DataStoreList' => $baseDir . '/libs/DataStoreList.php',
    'Date' => $baseDir . '/libs/Date.php',
    'DeleteAPIKeyController' => $baseDir . '/controllers/system/delete-api-key.php',
    'DeleteAllUsersController' => $baseDir . '/controllers/system/delete-all-users.php',
    'DeleteArticleController' => $baseDir . '/controllers/article/delete.php',
    'DeleteController' => $baseDir . '/controllers/ticket/delete.php',
    'DeleteCustomFieldController' => $baseDir . '/controllers/system/delete-custom-field.php',
    'DeleteCustomResponseController' => $baseDir . '/controllers/ticket/delete-custom-response.php',
    'DeleteDepartmentController' => $baseDir . '/controllers/system/delete-department.php',
    'DeleteStaffController' => $baseDir . '/controllers/staff/delete.php',
    'DeleteTagController' => $baseDir . '/controllers/ticket/delete-tag.php',
    'DeleteTopicController' => $baseDir . '/controllers/article/delete-topic.php',
    'DeleteUserController' => $baseDir . '/controllers/user/delete.php',
    'Department' => $baseDir . '/models/Department.php',
    'DisableMandatoryLoginController' => $baseDir . '/controllers/system/disable-mandatory-login.php',
    'DisableRegistrationController' => $baseDir . '/controllers/system/disable-registration.php',
    'DisableUserController' => $baseDir . '/controllers/user/disable.php',
    'DownloadController' => $baseDir . '/controllers/system/download.php',
    'ERRORS' => $baseDir . '/data/ERRORS.php',
    'EXCEPTIONS' => $baseDir . '/data/EXCEPTIONS.php',
    'EasyPeasyICS' => $vendorDir . '/phpmailer/phpmailer/extras/EasyPeasyICS.php',
    'EditArticleController' => $baseDir . '/controllers/article/edit.php',
    'EditCommentController' => $baseDir . '/controllers/ticket/edit-comment.php',
    'EditCustomFieldsController' => $baseDir . '/controllers/user/edit-custom-fields.php',
    'EditCustomResponseController' => $baseDir . '/controllers/ticket/edit-custom-response.php',
    'EditDepartmentController' => $baseDir . '/controllers/system/edit-department.php',
    'EditEmail' => $baseDir . '/controllers/user/edit-email.php',
    'EditMailTemplateController' => $baseDir . '/controllers/system/edit-mail-template.php',
    'EditPassword' => $baseDir . '/controllers/user/edit-password.php',
    'EditSettingsController' => $baseDir . '/controllers/system/edit-settings.php',
    'EditStaffController' => $baseDir . '/controllers/staff/edit.php',
    'EditSupervisedListController' => $baseDir . '/controllers/user/edit-supervised-list.php',
    'EditTagController' => $baseDir . '/controllers/ticket/edit-tag.php',
    'EditTitleController' => $baseDir . '/controllers/ticket/edit-title.php',
    'EditTopicController' => $baseDir . '/controllers/article/edit-topic.php',
    'Email' => $baseDir . '/libs/Email.php',
    'EmailPollingController' => $baseDir . '/controllers/system/email-polling.php',
    'EnableMandatoryLoginController' => $baseDir . '/controllers/system/enable-mandatory-login.php',
    'EnableRegistrationController' => $baseDir . '/controllers/system/enable-registration.php',
    'EnableUserController' => $baseDir . '/controllers/user/enable.php',
    'FileDownloader' => $baseDir . '/libs/FileDownloader.php',
    'FileManager' => $baseDir . '/libs/FileManager.php',
    'FileUploader' => $baseDir . '/libs/FileUploader.php',
    'File_Iterator' => $vendorDir . '/phpunit/php-file-iterator/src/Iterator.php',
    'File_Iterator_Facade' => $vendorDir . '/phpunit/php-file-iterator/src/Facade.php',
    'File_Iterator_Factory' => $vendorDir . '/phpunit/php-file-iterator/src/Factory.php',
    'GetAPIKeysController' => $baseDir . '/controllers/system/get-api-keys.php',
    'GetAllArticlesController' => $baseDir . '/controllers/article/get-all.php',
    'GetAllStaffController' => $baseDir . '/controllers/staff/get-all.php',
    'GetAllTicketsStaffController' => $baseDir . '/controllers/staff/get-all-tickets.php',
    'GetAuthorsController' => $baseDir . '/controllers/ticket/get-authors.php',
    'GetCustomFieldsController' => $baseDir . '/controllers/system/get-custom-fields.php',
    'GetCustomResponsesController' => $baseDir . '/controllers/ticket/get-custom-responses.php',
    'GetLogsController' => $baseDir . '/controllers/system/get-logs.php',
    'GetMailTemplateController' => $baseDir . '/controllers/system/get-mail-template.php',
    'GetMailTemplateListController' => $baseDir . '/controllers/system/get-mail-template-list.php',
    'GetNewTicketsStaffController' => $baseDir . '/controllers/staff/get-new-tickets.php',
    'GetSettingsController' => $baseDir . '/controllers/system/get-settings.php',
    'GetStaffController' => $baseDir . '/controllers/staff/get.php',
    'GetStatsController' => $baseDir . '/controllers/system/stats.php',
    'GetSupervisedTicketController' => $baseDir . '/controllers/user/get-supervised-tickets.php',
    'GetTagsController' => $baseDir . '/controllers/ticket/get-tags.php',
    'GetTicketStaffController' => $baseDir . '/controllers/staff/get-tickets.php',
    'GetUserByIdController' => $baseDir . '/controllers/user/get-user.php',
    'GetUserController' => $baseDir . '/controllers/user/get.php',
    'GetUsersController' => $baseDir . '/controllers/user/get-users.php',
    'Hashing' => $baseDir . '/libs/Hashing.php',
    'InitAdminController' => $baseDir . '/controllers/system/init-admin.php',
    'InitDatabaseController' => $baseDir . '/controllers/system/init-database.php',
    'InitSettingsController' => $baseDir . '/controllers/system/init-settings.php',
    'InstallationDoneController' => $baseDir . '/controllers/system/installation-done.php',
    'InviteStaffController' => $baseDir . '/controllers/staff/invite.php',
    'InviteUserController' => $baseDir . '/controllers/user/invite.php',
    'Language' => $baseDir . '/models/Language.php',
    'LastEventsStaffController' => $baseDir . '/controllers/staff/last-events.php',
    'LengthConfig' => $baseDir . '/data/length-config.php',
    'LinearCongruentialGenerator' => $baseDir . '/libs/LinearCongruentialGenerator.php',
    'ListBanUserController' => $baseDir . '/controllers/user/list-ban.php',
    'Log' => $baseDir . '/models/Log.php',
    'Logger' => $baseDir . '/libs/Logger.php',
    'LoginController' => $baseDir . '/controllers/user/login.php',
    'LogoutController' => $baseDir . '/controllers/user/logout.php',
    'MailSender' => $baseDir . '/libs/MailSender.php',
    'MailTemplate' => $baseDir . '/models/MailTemplate.php',
    'MailTexts' => $baseDir . '/data/MailTexts.php',
    'NullDataStore' => $baseDir . '/models/NullDataStore.php',
    ...
    'ReOpenController' => $baseDir . '/controllers/ticket/re-open.php',
    'RecoverMailTemplateController' => $baseDir . '/controllers/system/recover-mail-template.php',
    'RecoverPassword' => $baseDir . '/models/RecoverPassword.php',
    'RecoverPasswordController' => $baseDir . '/controllers/user/recover-password.php',
    'RemoveTagController' => $baseDir . '/controllers/ticket/remove-tag.php',
    'RequestException' => $baseDir . '/libs/RequestException.php',
    'ResendEmailTokenController' => $baseDir . '/controllers/user/resend-email-token.php',
    'ResendInviteStaffController' => $baseDir . '/controllers/staff/resend-invite-staff.php',
    'ResendInviteUserController' => $baseDir . '/controllers/user/resend-invite-user.php',
    'Response' => $baseDir . '/models/Response.php',
    'SMTP' => $vendorDir . '/phpmailer/phpmailer/class.smtp.php',
    'SearchAuthorsController' => $baseDir . '/controllers/ticket/search-authors.php',
    'SearchController' => $baseDir . '/controllers/ticket/search.php',
    'SearchTicketStaffController' => $baseDir . '/controllers/staff/search-tickets.php',
    ...
    'SeenController' => $baseDir . '/controllers/ticket/seen.php',
    'SendRecoverPasswordController' => $baseDir . '/controllers/user/send-recover-password.php',
    'Session' => $baseDir . '/models/Session.php',
    'SessionCookie' => $baseDir . '/models/SessionCookie.php',
    'Setting' => $baseDir . '/models/Setting.php',
    'SignUpController' => $baseDir . '/controllers/user/signup.php',
    'SingletonTrait' => $baseDir . '/libs/SingletonTrait.php',
    'Staff' => $baseDir . '/models/Staff.php',
    'Stat' => $baseDir . '/models/Stat.php',
    'Supervisedrelation' => $baseDir . '/models/SupervisedRelation.php',
    'Tag' => $baseDir . '/models/Tag.php',
    'TestIMAPController' => $baseDir . '/controllers/system/test-imap.php',
    'TestSMTPController' => $baseDir . '/controllers/system/test-smtp.php',
    'Text_Template' => $vendorDir . '/phpunit/php-text-template/src/Template.php',
    'Ticket' => $baseDir . '/models/Ticket.php',
    'TicketGetController' => $baseDir . '/controllers/ticket/get.php',
    'Ticketevent' => $baseDir . '/models/Ticketevent.php',
    'Topic' => $baseDir . '/models/Topic.php',
    'UnAssignStaffController' => $baseDir . '/controllers/staff/un-assign-ticket.php',
    'UnBanUserController' => $baseDir . '/controllers/user/un-ban.php',
    'User' => $baseDir . '/models/User.php',
    'ValidationException' => $baseDir . '/libs/Validator.php',
    'Validator' => $baseDir . '/libs/Validator.php',
    'VerifyController' => $baseDir . '/controllers/user/verify.php',
